...
zss_editor.insertImageUrl = function(url, alt) {
    zss_editor.restorerange();
//    var html = "<img src="+url+" style='max-width:100%;'/>";
    var html = '<img src=' + url + ' alt="' + alt + '" style="max-width:100% !important;"/>';
...
zss_editor.insertImageBase64String = function(imageBase64String, alt) {
    zss_editor.restorerange();
    var html = '<img src="data:image/jpeg;base64,'+imageBase64String+'" alt="'+alt+'" style="max-width:100% !important;" />';
    zss_editor.insertHTML(html);
    zss_editor.enabledEditingItems();
...
zss_editor.setEndEditing = function() {
//    var editor = $('#zss_editor_content');
//    editor.focusout();
    $('#zss_editor_content').blur();
}
